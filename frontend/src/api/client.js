...
// const BASE_URL = process.env.API_URL || 'https://ugsf-backend-19-02-production.up.railway.app/api/v1';
const BASE_URL = process.env.API_URL || 'http://10.105.241.112:3000/api/v1';
